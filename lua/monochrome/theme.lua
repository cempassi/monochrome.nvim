...
function M.load_syntax()
	local syntax = {
		...
		MatchParen = { fg = colors.dark_blue, bg = colors.bg, style = "bold" },
		...
		TSConditional = { fg = colors.dark_yellow },
		TSConstant = { fg = colors.fg },
		TSConstBuiltin = { fg = colors.neutral_red },
		TSConstMacro = {},
		...
		TSRepeat = { fg = colors.dark_yellow },
		TSString = { fg = colors.bright_blue },
		...
		TSDanger = { style = "bold" },
		TSType = { fg = colors.gray7 },
		TSTypeBuiltin = { fg = colors.faded_green },
		TSVariable = { fg = colors.fg },
		TSVariableBuiltin = { fg = colors.dark_blue, style = "italic" },
...
function M.load_plugin_syntax()
	local plugin_syntax = {
		...
		diffAdded = { fg = colors.neutral_green },
		diffChanged = { fg = colors.dark_yellow },
		diffRemoved = { fg = colors.neutral_red },
		diffOldFile = {},
		diffNewFile = {},
		diffIndexLine = {},
		diffFile = {},
		...
		GitSignsChangeNr = { link = 'diffChanged' },
		GitSignsChangeLn = { link = 'diffChanged' },
		GitSignsChangeDelete = { fg = colors.violet },
		...
		LspSagaDiagnosticBorder = { fg = colors.fg },
		...
		TelescopePreviewHyphen = { link = "String" },
		TelescopeResultsDiffUntracked = { fg = colors.faded_red },
